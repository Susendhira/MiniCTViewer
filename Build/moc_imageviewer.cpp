...
QT_MOC_LITERAL(1, 12, 18), // "annotationFinished"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 10), // "Annotation"
QT_MOC_LITERAL(4, 43, 3) // "ann"

    },
    "ImageViewer\0annotationFinished\0\0"
    "Annotation\0ann"
};
...
void ImageViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->annotationFinished((*reinterpret_cast< const Annotation(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ImageViewer::*)(const Annotation & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageViewer::annotationFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImageViewer::annotationFinished(const Annotation & _t1)
{
